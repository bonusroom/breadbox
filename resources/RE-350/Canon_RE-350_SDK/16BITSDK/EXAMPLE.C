/***************************************************************************
	...
	DESCRIPTION:
		...
		This is a simple Windows application to demonstrate
...
int	PASCAL WinMain( HANDLE hInstance, HANDLE hPrevInstance, LPSTR lpszCmdLine, int nCmdShow )
{
	...
	if ( (hLibDLL = LoadLibrary( RE350_LIBNAME )) <= HINSTANCE_ERROR )
	{	
...
LONG	FAR PASCAL __export WndProc( HWND hWnd, UINT wMessage, WPARAM wParam, LPARAM lParam )
{
	PAINTSTRUCT	ps;
	...
	switch( wMessage )
	{
		...
		case	WM_INITMENU:
			CheckMenuItem( wParam, IDM_COM1, MF_UNCHECKED );
			CheckMenuItem( wParam, IDM_COM2, MF_UNCHECKED );
			CheckMenuItem( wParam, IDM_COM3, MF_UNCHECKED );
			CheckMenuItem( wParam, IDM_COM4, MF_UNCHECKED );

			switch( iCommPort )
			{
				case	RE350_COM1:
					CheckMenuItem( wParam, IDM_COM1, MF_CHECKED );
					break;
				case	RE350_COM2:
					CheckMenuItem( wParam, IDM_COM2, MF_CHECKED );
					break;
				case	RE350_COM3:
					CheckMenuItem( wParam, IDM_COM3, MF_CHECKED );
					break;
				case	RE350_COM4:
					CheckMenuItem( wParam, IDM_COM4, MF_CHECKED );
					break;
			}
			break;
